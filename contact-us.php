...
<head>
 ...
 <meta name="keywords"content="<?php echo $sitename ?> and Courier Services, Logistics, mailroom , warehousing , best courier service worlwide, global logistics company, ecommerce delivery, ecommerce courier service ,local shipment, international shipment, same day delivery , logistics support, Amazon delivery, delivery services, delivery service for ecommerce, ecommerce delivery in Globally , deal dey delivery, Global logistics company">
        
<meta name="description" content="<?php echo $sitename ?> is a leading logistics and distribution services company established in 2009. We offer a wide array of express courier and logistic support solutions to our various customers">
...
<meta name="title" content="<?php echo $sitename ?> | Express Delivery, Courier &amp; Shipping Services | Worlwide"/>

<meta property="og:type" content="Logistics and Courier Services" />
<meta property="og:title" content="<?php echo $sitename ?> | Express Delivery, Courier &amp; Shipping Services | Worlwide" />
<meta property="og:description" content="<?php echo $sitename ?> is a leading logistics and distribution services company established in 2009. We offer a wide array of express courier and logistic support solutions to our various customers">
<meta name="keywords">
<meta property="og:site_name" content="<?php echo $sitename ?>"/>


    <title>Contact Us :: <?php echo $sitename ?> | Express Delivery, Courier &amp; Shipping Services | Worlwide</title>
				...
				<div class="row">
							...
							<div class="ft-contact-page-contact-info">
								<div class="ft-contact-cta-items d-flex">
									...
									<div class="ft-contact-cta-text headline pera-content">
										...
										<p>
										Street 2366 E Sunnyside Rdcourier, Idaho Falls Idaho, 83404, United States.
										</p>
									</div>
								</div>
								<div class="ft-contact-cta-items d-flex">
					...
					<div class="col-lg-6">
						<div class="ft-contact-page-form-wrapper headline">
							<h3 class="text-center">Send Us A Mail</h3>
							
<form class="form-group" method="post" id="contactForm" name="contactForm" onSubmit="return false" novalidate="novalidate">
								<div class="row">
									<div class="col-lg-6">
									...
									<div class="col-lg-12">
	<button name="sendMessage" id="sendMessage" type="submit" onClick="sendMsgFunc()">Send Message</button>
	<button type="reset" name="clear_form" id="clear_form" class="btn btn-primary" style="display:none;">Clear Message</button>
									</div>
								</div>
							</form>
						</div>
